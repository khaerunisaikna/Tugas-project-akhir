    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 shadow" style="width:100%">
        <div class="container">
            <a class="navbar-brand">
                <img src="../../assets/img/12.jpg" width="30" height="30" alt="logosmk">
                <span class="align-middle">MUSIC.CO 2022</span>
            </a>
        ...
        <div class="container text-light">
            <div class="row p-4">
                <div class="col text-center">
                    <h4>CONTACT</h4>
                    <div>
                        <p class="m-2"><i class="fa fa-envelope mr-2"></i>music.co2022@gmail.com</p>
                        <p class="m-2"><i class="fa fa-phone mr-2"></i>099999</p>
                        <p class="m-2"><i class="fa fa-fax mr-2"></i>083843654127</p>
                    </div>
                    <div>
                ...
                <div class="col text-center">
                    <h4>Alamat</h4>
                    <p>Jl.Budi Utomo<br>Jakarta Pusat<br>DKI Jakarta</p>
                </div>
                <div class="col text-center">
                    <h4>NAVIGATE</h4>
